...
async function seed() {
    ...
    const sampleItems = [
        ...
        },
        {
            ...
            description: 'Beef patty topped with crispy bacon, onion rings, and smokey BBQ sauce.',
            price: 14.99,
            imageUrl: 'https://images.unsplash.com/photo-1594212699903-ec8a3eca50f5?w=800&auto=format&fit=crop&q=60',
            category: 'burgers',
            available: true,
        },
        {
        ...
        },
        {
            ...
            price: 4.99,
            imageUrl: 'https://images.unsplash.com/photo-1573080496987-a199f8cd75ec?w=800&auto=format&fit=crop&q=60',
            category: 'sides',
            available: true,
        },
        {
